...
from .views import RegisterUser, LoginUser, logout_user, searche_books, BookList, ViewComments, AddComments
...
urlpatterns = [
    ...
    path('add_comment/<int:pk>',  AddComments.as_view(),    name = 'add_comments_path'),
]
